    ...
    private PayrollSlipDTO getDetailedSalarySlip(String salarySlipName, String accessToken, String sid) {
        try {
            ...
            if (response != null && response.getStatusCode().is2xxSuccessful() && response.getBody() != null) {
                ...
                slip.setTotalWorkingDays(NumberUtil.getDoubleValue(data.get("total_working_days")));
                slip.setPaymentDays(NumberUtil.getDoubleValue(data.get("payment_days")));
                slip.setHourRate(NumberUtil.getDoubleValue(data.get("hour_rate")));
                slip.setTotalWorkingHours(NumberUtil.getDoubleValue(data.get("total_working_hours")));
                slip.setGrossPay(NumberUtil.getDoubleValue(data.get("gross_pay")));
                slip.setTotalDeduction(NumberUtil.getDoubleValue(data.get("total_deduction")));
                slip.setNetPay(NumberUtil.getDoubleValue(data.get("net_pay")));
                slip.setRoundedTotal(NumberUtil.getDoubleValue(data.get("rounded_total")));
                ...
                if (earningsData != null) {
                    ...
                    for (Map<String, Object> earning : earningsData) {
                        ...
                        detail.setAmount(NumberUtil.getDoubleValue(earning.get("amount")));
                ...
                if (deductionsData != null) {
                    ...
                    for (Map<String, Object> deduction : deductionsData) {
                        ...
                        detail.setAmount(NumberUtil.getDoubleValue(deduction.get("amount")));
                ...
                if (loanRepaymentData != null) {
                    ...
                    for (Map<String, Object> loan : loanRepaymentData) {
                        ...
                        detail.setPrincipalAmount(NumberUtil.getDoubleValue(loan.get("principal_amount")));
                        detail.setInterestAmount(NumberUtil.getDoubleValue(loan.get("interest_amount")));
                        detail.setTotalPayment(NumberUtil.getDoubleValue(loan.get("total_payment")));
        ...
        try {
            ...
            if (response != null && response.getStatusCode().is2xxSuccessful() && response.getBody() != null) {
                ...
                if (data != null) {
                    ...
                    components.setTotalGross(NumberUtil.getDoubleValue(data.get("total_gross")));
                    components.setTotalDeduction(NumberUtil.getDoubleValue(data.get("total_deduction")));
                    components.setTotalNet(NumberUtil.getDoubleValue(data.get("total_net")));
                    components.setCurrency((String) data.get("currency"));
                    components.setEmployeeCount(NumberUtil.getIntValue(data.get("employee_count")));
                    ...
                    if (earningsData != null) {
                        for (Map<String, Object> earning : earningsData) {
                            ...
                            component.setAmount(NumberUtil.getDoubleValue(earning.get("amount")));
                    ...
                    if (deductionsData != null) {
                        for (Map<String, Object> deduction : deductionsData) {
                            ...
                            component.setAmount(NumberUtil.getDoubleValue(deduction.get("amount")));
