...
copy  
    ...
    git/python/hrms to path/to/your/erp/hrms/hrms (NB change the second hrms , which content python code only , the same things for erpnext)
    git/python/erpnext to  path/to/your/erp/erpnext/erpnext
