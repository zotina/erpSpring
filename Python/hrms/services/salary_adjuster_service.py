...
class SalaryAdjusterService:
    ...
    def adjust_salary_slips(self, salary_component, reference_amount, comparison_type, adjustment_type, adjustment_rate, yearDebut, yearFin):
        """
        ...
        try:
            ...
            salary_slips = self.filter_model.get_filtered_salary_slips(
                salary_component, reference_amount, comparison_type , yearDebut, yearFin
            )
