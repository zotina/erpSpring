...
@frappe.whitelist(allow_guest=False)
def updateBaseAssignement(salary_component, montant, infOrSup, minusOrPlus, taux, yearDebutParam =None, yearFinParam =None):
    """
    ...
    try:
        ...
        return service.adjust_salary_slips(
            ...
            yearDebut = yearDebutParam,
            yearFin = yearFinParam
        )
    except Exception as e:
