...
class PayrollGeneratorService:
    ...
    def generate_payroll_period(self, employee_id, start_month, end_month, base_amount):
        """
        ...
        try:
            ...
            dto_result = self._generate_payroll_dtos(employee_id, start_month, end_month, base_amount)
    ...
    def _generate_payroll_dtos(self, employee_id, start_month, end_month, base_amount):
        ...
        try:
            ...
            while current_date <= end_date:
                try:
                    ...
                    if self._salary_slip_exists(employee_id, current_date):
